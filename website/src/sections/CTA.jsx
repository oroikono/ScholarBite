...
export default function CTA() {
  return (
    <div className="bg-gradient-to-br from-dark via-dark2 to-dark3 py-24" style={{ display: 'flex', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: '600px', padding: '0 2rem', textAlign: 'center' }}>
        <motion.h2
